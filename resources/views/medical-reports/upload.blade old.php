      ...
      <div class="col-12 col-md-8">
        <div class="form_container contact-form">
          <form action="{{ route('medical-reports.upload') }}" method="POST" enctype="multipart/form-data" id="reportUploadForm">
            ...
            <!-- Patient Information (Pre-filled from authenticated user) -->
            <div class="form-row">
              <div class="col-lg-6">
                <div>
                  <input type="text" name="patient_name" placeholder="Patient Name"
                         value="{{ old('patient_name', auth()->user()->name) }}" required />
                  @error('patient_name')
              ...
              <div class="col-lg-6">
                <div>
                  <input type="number" name="age" placeholder="Patient Age"
                         min="1" max="120" value="{{ old('age', auth()->user()->age ?? '') }}" required />
                  @error('age')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="mb-3">
              <p class="mb-2">
                I agree to the
                <a href="{{ route('disclaimer') }}" target="_blank" class="text-decoration-underline">Disclaimer</a>,
                <a href="{{ route('terms') }}" target="_blank" class="text-decoration-underline">Terms &amp; Conditions</a>, and
                <a href="{{ route('privacy') }}" target="_blank" class="text-decoration-underline">Privacy Policy</a>.
              </p>
      ...
      <div class="col-md-4">
        <div class="info_container">
          ...
          <div class="user_info">
            ...
            <div class="user_details">
              ...
              <small class="text-muted">
                ...
                Reports will be associated with your account
              </small>
            </div>
          </div>
          ...
          <div class="pricing_info">
            ...
            <ul>
              <li>All type of blood report 200/- per report</li>
              <li>X-ray 300/- per report</li>
              <li>Ultrasound report 350/- per report</li>
              <li>C.T scan & MRI 400 per report</li>
            </ul>
