        ...
        <div class="report_details_container">
            ...
            <div class="row">
              <div class="col-md-6">
                <p><strong>Current Status:</strong>
                  <span class="badge badge-{{ $report->status == 'completed' ? 'success' : ($report->status == 'analyzing' ? 'warning' : 'secondary') }}">
                    {{ $report->status_name }}
                  </span>
                </p>
              ...
              <div class="col-md-6">
                ...
                @if($report->analyzed_at)
                  <p><strong>Analyzed On:</strong> {{ $report->analyzed_at->format('M d, Y h:i A') }}</p>
                @endif
              </div>
            </div>
          </div>
          ...
          <div class="uploaded_files bg-white border p-4 rounded mb-4">
            ...
            <div class="files_list">
              @foreach($report->file_paths as $index => $filePath)
                <div class="file_item d-flex justify-content-between align-items-center p-2 border-bottom">
                  <div>
          ...
          <div class="action_buttons">
            ...
            @if($report->analysis_result)
              ...
              <a href="{{ route('medical-reports.download-pdf', $report->id) }}" class="btn btn-outline-info">
        ...
        <div class="sidebar_container">
          ...
          <div class="contact_card bg-info text-white p-4 rounded mb-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><strong>Email:</strong> info@medicalanalysis.com</li>
